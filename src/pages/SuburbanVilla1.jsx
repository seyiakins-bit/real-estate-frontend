// src/pages/SuburbanVilla1.jsx
import React, { useState } from "react";
import { Carousel } from "react-responsive-carousel";
import "react-responsive-carousel/lib/styles/carousel.min.css";

function SuburbanVilla1() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 w-full">
      <h1 className="text-3xl font-bold mb-6 text-center">
        Luxury 5-Bedroom Suburban Villa – Ikate, Lekki
      </h1>
      ...
      <div className="mt-8 bg-white p-6 rounded-xl shadow-md">
        ...
        <p>
          Experience modern suburban luxury in this 5-bedroom villa located in the peaceful
          neighborhood of Ikate, Lekki. Designed for comfort and elegance, this home offers
          contemporary architecture, lush landscaping, and high-end finishes throughout.
        </p>

        <h2 className="font-semibold mt-6 mb-2">Features:</h2>
        <ul className="list-disc ml-6">
          <li>5 Spacious Bedrooms (All En-Suite)</li>
          <li>Modern Fitted Kitchen with Pantry</li>
          <li>Swimming Pool & Private Garden</li>
          <li>2 Living Rooms & Family Lounge</li>
          <li>24/7 Power, Security & CCTV Surveillance</li>
        </ul>

        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-2xl font-semibold text-green-600">₦180,000,000</p>
          <a
