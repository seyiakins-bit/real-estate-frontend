  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 w-full">
      <h1 className="text-3xl font-bold mb-6 text-center">
        Elegant 5-Bedroom Family Duplex – Osapa London, Lekki
      </h1>

      {/* Carousel */}
      <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} interval={4000}>
        {[
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760177553/Duplex6_tpmajq.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760177572/Duplex8_rd5vdc.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760177584/Duplex9_is7nta.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760177592/Duplex10_votqkq.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760177603/bed1_playing_ground_compound_zr4qjf.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760177608/Duplex1_i99ezp.jpg",
        ].map((img, idx) => (
          <div key={idx}>
            <img src={img} alt={`Family Duplex 2 view ${idx + 1}`} className="w-full h-80 object-cover rounded-lg" />
          </div>
        ))}
      </Carousel>
      ...
      <div className="mt-8 bg-white p-6 rounded-xl shadow-md">
        ...
        <p>
          This stunning 5-bedroom family duplex in Osapa London, Lekki, features modern architecture, smart home
          integration, and luxury finishes. Ideal for large families who value comfort and class.
        </p>

        <h2 className="font-semibold mt-6 mb-2">Features:</h2>
        <ul className="list-disc ml-6">
          <li>5 Spacious Bedrooms</li>
          <li>5 Bathrooms + 6 Toilets</li>
          <li>Fully Fitted Kitchen with Island</li>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-2xl font-semibold text-green-600">₦130,000,000</p>
          <a
      ...
      <div className="w-full mt-8 rounded-lg overflow-hidden shadow-lg">
        <iframe
          ...
          title="Osapa London Duplex Location"
          src="https://www.google.com/maps?q=Osapa+London,+Lekki,+Lagos&output=embed"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
