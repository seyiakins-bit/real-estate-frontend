  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 w-full">
      <h1 className="text-3xl font-bold mb-6 text-center">
        Spacious 4-Bedroom Family Duplex – Chevron Drive, Lekki
      </h1>
      ...
      <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} interval={4000}>
        {[
          ...
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175828/bed1_bedroom_s5iypx.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175841/bed1_bedroom1_vjqakt.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175850/bed1_bedroom2_ylumwd.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175860/bed1_bedroom3_mkmzl2.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175882/bed1_bedroom4_qwncqu.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175893/bed1_kitchen_wvs9wr.jpg",
          "https://res.cloudinary.com/dlu8e511s/image/upload/v1760175906/bed1_living_room_view_vlwg6k.jpg",
        ].map((img, idx) => (
          <div key={idx}>
            <img src={img} alt={`Family Duplex view ${idx + 1}`} className="w-full h-80 object-cover rounded-lg" />
          </div>
        ))}
      </Carousel>
      ...
      <div className="mt-8 bg-white p-6 rounded-xl shadow-md">
        ...
        <p>
          A beautifully designed 4-bedroom family duplex located in the secure and serene Chevron Drive area of Lekki.
          This home is perfect for families seeking a blend of luxury, comfort, and privacy.
        </p>

        <h2 className="font-semibold mt-6 mb-2">Features:</h2>
        <ul className="list-disc ml-6">
          <li>4 Spacious Bedrooms</li>
          <li>4 Bathrooms + 5 Toilets</li>
          <li>Modern Fully Fitted Kitchen</li>
          <li>Private Parking Space</li>
          <li>24/7 Power and Security</li>
        </ul>
      ...
      <div className="w-full mt-8 rounded-lg overflow-hidden shadow-lg">
        <iframe
          ...
          title="Chevron Drive Duplex Location"
          src="https://www.google.com/maps?q=Chevron+Drive+Lekki,+Lagos&output=embed"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
